...
4)):h}function f(h){a.debug.isEnabled&&a.debug("get",h);var c,k;if(c=h._id){(k=b[c])?a.debug.isEnabled&&a.debug("Local cache hit: "+k._dump(!0)):a.debug.isEnabled&&a.debug("Local cache miss: "+c);if(k)return k;if(h.model)return c=h.model.id,k=h[c],a.debug.isEnabled&&a.debug(c+"="+k),n(k,h)}else if(h.model){c=h.model.id;if(k=h[c])return n(k,h);if(h.model.singleton)return d(h.model)}else a.warn("Invalid opts to cache",{opts:h});return null}function m(a){var b={_id:a._id},h=a.model;h.id&&a[h.id]&&(b.model=
...
},model:function(a){if(this.installed)throw Error("Cannot create new models once the object graph is established!");var b=this;if(arguments.length){if(1==arguments.length){if(m.isArray(arguments[0]))return g.map(arguments[0],function(a){return b._model(a.name,a)});var c,k;m.isString(arguments[0])?(c=arguments[0],k={}):(k=arguments[0],c=k.name);return this._model(c,k)}return"string"==typeof arguments[0]?this._model(arguments[0],arguments[1]):g.map(arguments,function(a){return b._model(a.name,a)})}return null},
descriptor:function(a){var c=[];if(siesta.ext.httpEnabled){a.collection=this;for(var k=siesta.ext.http._resolveMethod(a.method),f=[],g=[],d=0;d<k.length;d++){var e=k[d];-1<b.indexOf(e)?f.push(e):g.push(e)}f.length&&(k=r({},a),k.method=f,k=new siesta.ext.http.RequestDescriptor(k),siesta.ext.http.DescriptorRegistry.registerRequestDescriptor(k),c.push(k));g.length&&(a=r({},a),a.method=g,a=new siesta.ext.http.ResponseDescriptor(a),siesta.ext.http.DescriptorRegistry.registerResponseDescriptor(a),c.push(a))}else throw Error("HTTP module not installed.");
return c},_dump:function(a){var b={};b.installed=this.installed;b.docId=this._docId;b.name=this.name;b.baseURL=this.baseURL;return a?m.prettyPrint(b):b},count:function(a){var b=m.defer(a);a=g.map(this._models,function(a){return g.bind(a.count,a)});m.async.parallel(a,function(a,c){var k;a||(k=g.reduce(c,function(a,b){return a+b},0));b.finish(a,k)});return b.promise}});t.exports=d},{"../vendor/observe-js/src/observe":44,"./cache":8,"./collectionRegistry":10,"./error":11,"./events":12,"./index":13,"./log":14,
...
console),d.Level.error);this.fatal=n(this,p.bind(console.error?console.error:console.log,console),d.Level.fatal)}function n(d,f,e){var g=function(c){d.performLog(f,e,c,arguments)};Object.defineProperty(g,"isEnabled",{get:function(){var c=d.currentLevel();return e>=c},enumerable:!0,configurable:!0});g.f=f;g.logger=d;g.level=e;return g}var p=e("./util")._,l={};d.Level={trace:0,debug:1,info:2,warning:3,warn:3,error:4,fatal:5};d.LevelText={};d.LevelText[d.Level.trace]="TRACE";d.LevelText[d.Level.debug]=
"DEBUG";d.LevelText[d.Level.info]="INFO ";d.LevelText[d.Level.warning]="WARN ";d.LevelText[d.Level.error]="ERROR";d.levelAsText=function(d){return this.LevelText[d]};d.loggerWithName=function(e){return new d(e)};d.prototype.currentLevel=function(){var e=l[this.name];return e?e:d.Level.trace};d.prototype.setLevel=function(d){l[this.name]=d};d.prototype.override=function(e,f,l){var g=this[d.levelAsText(e).trim().toLowerCase()].f,c=Array.prototype.slice.call(arguments,3,arguments.length);this.performLog(g,
e,l,c,f)};d.prototype.performLog=function(e,f,l,g,c){if((void 0!==c?c:this.currentLevel())<=f){e=p.partial(e,d.levelAsText(f)+" ["+this.name+"]: "+l);f=[];for(l=0;l<g.length;l++)f[l]=g[l];f.splice(0,1);e.apply(e,f)}};t.exports=d},{"./util":28}],15:[function(e,t,q){function d(c){n.call(this,c);this.related=[];this.relatedCancelListeners={}}var n=e("./RelationshipProxy");e("./store");var p=e("./util"),l=p._;e("./error");var r=e("./modelEvents"),f=e("./events").wrapArray;e("./modelInstance");var m=e("../vendor/observe-js/src/observe").ArrayObserver,
g=e("./modelEvents").ModelEventType;d.prototype=Object.create(n.prototype);l.extend(d.prototype,{clearReverse:function(c){var a=this;l.each(c,function(b){var c=a.reverseProxyForInstance(b),h=c.related.indexOf(a.object);c.makeChangesToRelatedWithoutObservations(function(){c.splice(h,1)})})},setReverseOfAdded:function(c){var a=this;l.each(c,function(b){var c=a.reverseProxyForInstance(b);c.makeChangesToRelatedWithoutObservations(function(){c.splice(0,0,a.object)})})},wrapArray:function(c){var a=this;
f(c,this.reverseName,this.object);c.arrayObserver||(c.arrayObserver=new m(c),c.arrayObserver.open(function(b){b.forEach(function(b){var h=b.addedCount?c.slice(b.index,b.index+b.addedCount):[],d=b.removed;a.clearReverse(d);a.setReverseOfAdded(h);var e=a.getForwardModel();r.emit({collection:e.collectionName,model:e.name,_id:a.object._id,field:a.getForwardName(),removed:d,added:h,type:g.Splice,index:b.index,obj:a.object})})}))},get:function(c){var a=p.defer(c);c=a.finish.bind(a);c(null,this.related);
return a.promise},validate:function(c){return"[object Array]"!=Object.prototype.toString.call(c)?"Cannot assign scalar to many to many":null},set:function(c,a){this.checkInstalled();if(c){var b;if(b=this.validate(c))return b;this.clearReverseRelated(a);this.setIdAndRelated(c,a);this.wrapArray(c);this.setIdAndRelatedReverse(c,a)}else this.clearReverseRelated(a),this.setIdAndRelated(c,a)},install:function(c){n.prototype.install.call(this,c);this.wrapArray(this.related);c["splice"+p.capitaliseFirstLetter(this.reverseName)]=
l.bind(this.splice,this)},registerRemovalListener:function(c){this.relatedCancelListeners[c._id]=c.listen(function(a){}.bind(this))}});t.exports=d},{"../vendor/observe-js/src/observe":44,"./RelationshipProxy":6,"./error":11,"./events":12,"./modelEvents":18,"./modelInstance":19,"./store":26,"./util":28}],16:[function(e,t,q){function d(c){this._opts=c;r.extendFromOpts(this,c,{model:null,data:null,objects:[],disableevents:!1,_ignoreInstalled:!1,callInit:!0});f.extend(this,{errors:[],subTaskResults:{},
_newObjects:[]})}var n=e("./store"),p=e("./modelInstance");q=e("./log");e("./error");var l=e("./cache"),r=e("./util"),f=r._,m=r.async;e("./modelEvents");var g=q.loggerWithName("Mapping");g.setLevel(q.Level.trace);f.extend(d.prototype,{mapAttributes:function(){for(var c=0;c<this.data.length;c++){var a=this.data[c],b=this.objects[c];a!=b&&b&&(f.each(this.model._attributeNames,function(c){void 0!==a[c]&&(this.disableevents?b.__values[c]=a[c]:b[c]=a[c])}.bind(this)),a._rev&&(b._rev=a._rev))}},_map:function(){var c=
this,a;this.mapAttributes();var b=f.keys(c.subTaskResults);f.each(b,function(b){for(var h=c.subTaskResults[b],d=h.indexes,h=h.objects,g=c.getRelatedData(b).relatedData,h=r.unflattenArray(h,g),g=0;g<h.length;g++){var e=d[g],f=c.errors[e];a=f?f[b]:null;if(!a){var f=h[g],l=c.objects[e];l&&(a=l.__proxies[b].set(f,{disableevents:c.disableevents}))&&(c.errors[e]||(c.errors[e]={}),c.errors[e][b]=a)}}})},_lookup:function(c){var a=r.defer(c);c=a.finish.bind(a);for(var b=this,k=[],h=[],d=0;d<this.data.length;d++)if(!this.objects[d]){var e,
m=this.data[d];e="string"==typeof m||"number"==typeof m||m instanceof String;m?e?(e={index:d,datum:{}},e.datum[b.model.id]=m,k.push(e)):m instanceof p?this.objects[d]=m:m._id?h.push({index:d,datum:m}):m[b.model.id]?k.push({index:d,datum:m}):this.objects[d]=b._new():this.objects[d]=null}r.async.parallel([function(a){var c=f.pluck(f.pluck(h,"datum"),"_id");c.length?n.getMultipleLocal(c,function(k,d){if(!k)for(var g=0;g<c.length;g++){var e=d[g],f=c[g],v=h[g];e||(e=l.get({_id:f}))||(e=b._new({_id:f},
!b.disableevents));b.objects[v.index]=e}a(k)}):a()},function(a){var c=f.pluck(f.pluck(k,"datum"),b.model.id);c.length?(g.trace.isEnabled&&g.trace("Looking up remoteIdentifiers: "+r.prettyPrint(c)),n.getMultipleRemote(c,b.model,function(h,e){if(!h){if(g.trace.isEnabled){var f={};for(d=0;d<e.length;d++)f[c[d]]=e[d]?e[d]._id:null;g.trace("Results for remoteIdentifiers: "+r.prettyPrint(f))}for(d=0;d<e.length;d++){var y=e[d],f=k[d];if(y)b.objects[f.index]=y;else{var y=c[d],m={model:b.model};m[b.model.id]=
y;(m=l.get(m))?b.objects[f.index]=m:(b.objects[f.index]=b._new(),b.objects[f.index][b.model.id]=y)}}}a(h)})):a()}],c);return a.promise},_lookupSingleton:function(c){var a=r.defer(c);c=a.finish.bind(a);for(var b=f.pluck(this.data,"_id"),k,h=0;h<b.length;h++)if(b[h]){k={_id:b[h]};break}for(var b=l.getSingleton(this.model)||this._new(k),h=0;h<this.data.length;h++)this.objects[h]=b;c();return a.promise},_new:function(){var c=this.model,c=c._new.apply(c,arguments);this._newObjects.push(c);return c},start:function(c){if(this.data.length){var a=
this,b=[];b.push(f.bind(this.model.singleton?this._lookupSingleton:this._lookup,this));b.push(f.bind(this._executeSubOperations,this));r.async.parallel(b,function(){try{a._map();var b;b=a.callInit?f.reduce(a._newObjects,function(a,b){var h=b.model.init;h&&(r.paramNames(h).length?a.push(f.bind(h,b,c)):h.call(b));return a},[]):[];m.parallel(b,function(){c(a.errors.length?a.errors:null,a.objects)})}catch(h){console.error("caught error",h),c(h)}})}else c(null,[])},getRelatedData:function(c){for(var a=
[],b=[],k=0;k<this.data.length;k++){var h=this.data[k];h&&h[c]&&(a.push(k),b.push(h[c]))}return{indexes:a,relatedData:b}},processErrorsFromTask:function(c,a,b){if(a.length){var k=this.getRelatedData(c).relatedData;a=r.unflattenArray(a,k);for(k=0;k<a.length;k++){var h=b[k],d=a[k],g=d;r.isArray(d)&&(g=f.reduce(d,function(a,b){return a||b},!1));g&&(this.errors[h]||(this.errors[h]={}),this.errors[h][c]=d)}}},_executeSubOperations:function(c){var a=this,b=f.keys(this.model.relationships);b.length?(b=f.reduce(b,
function(b,c){var g=a.model.relationships[c],e=g.forwardName==c?g.reverseModel:g.forwardModel;e.singleton&&!g.isReverse&&this.data.forEach(function(a){a[c]||(a[c]={})});var g=this.getRelatedData(c),f=g.indexes,g=g.relatedData;if(g.length)var g=r.flattenArray(g),l=new d({model:e,data:g,disableevents:a.disableevents,_ignoreInstalled:a._ignoreInstalled,callInit:this.callInit});l&&b.push(function(b){l.start(function(k,d){a.subTaskResults[c]={errors:k,objects:d,indexes:f};a.processErrorsFromTask(c,l.errors,
f);b()})});return b}.bind(this),[]),m.parallel(b,function(a){c(a)})):c()}});t.exports=d},{"./cache":8,"./error":11,"./log":14,"./modelEvents":18,"./modelInstance":19,"./store":26,"./util":28}],17:[function(e,t,q){function d(a){var b=this;this._opts=a?w.extend({},a):{};g.extendFromOpts(this,a,{methods:{},attributes:[],collection:function(a){g.isString(a)&&(a=n[a]);return a},id:"id",relationships:[],name:null,indexes:[],singleton:!1,statics:this.installStatics.bind(this),properties:{},init:null,remove:null});
this.attributes=d._processAttributes(this.attributes);w.extend(this,{_installed:!1,_relationshipsInstalled:!1,_reverseRelationshipsInstalled:!1,children:[]});Object.defineProperties(this,{_relationshipNames:{get:function(){return Object.keys(b.relationships)},enumerable:!0},_attributeNames:{get:function(){var a=[];b.id&&a.push(b.id);w.each(b.attributes,function(b){a.push(b.name)});return a},enumerable:!0,configurable:!0},installed:{get:function(){return b._installed&&b._relationshipsInstalled&&b._reverseRelationshipsInstalled},
enumerable:!0,configurable:!0},descendants:{get:function(){return w.reduce(b.children,function(a,b){return Array.prototype.concat.call(a,b.descendants)}.bind(b),w.extend([],b.children))},enumerable:!0},dirty:{get:function(){if(siesta.ext.storageEnabled)return!!Object.keys((siesta.ext.storage._unsavedObjectsByCollection[this.collectionName]||{})[this.name]||{}).length},enumerable:!0},collectionName:{get:function(){return this.collection.name},enumerable:!0}});k.ProxyEventEmitter.call(this,this.collectionName+
":"+this.name)}q=e("./log");var n=e("./collectionRegistry").CollectionRegistry,p=e("./error").InternalSiestaError,l=e("./RelationshipType"),r=e("./query"),f=e("./mappingOperation"),m=e("./modelInstance"),g=e("./util"),c=e("./cache");e("./store");var a=e("extend"),b=e("./modelEvents"),k=e("./events"),h=e("./events").wrapArray;e("./RelationshipProxy");var v=e("./OneToManyProxy"),y=e("./OneToOneProxy"),C=e("./manyToManyProxy"),A=e("./reactiveQuery"),x=e("./ArrangedReactiveQuery"),w=g._,B=g.guid,D=b.ModelEventType,
z=q.loggerWithName("Model");w.extend(d,{_processAttributes:function(a){return w.reduce(a,function(a,b){"string"==typeof b?a.push({name:b}):a.push(b);return a},[])}});d.prototype=Object.create(k.ProxyEventEmitter.prototype);w.extend(d.prototype,{installStatics:function(a){a&&w.each(Object.keys(a),function(b){this[b]?z.error('Static method with name "'+b+'" already exists. Ignoring it.'):this[b]=a[b].bind(this)}.bind(this));return a},installRelationships:function(){if(this._relationshipsInstalled)throw new p('Relationships for "'+
this.name+'" have already been installed');this._relationships=[];if(this._opts.relationships)for(var a in this._opts.relationships)if(this._opts.relationships.hasOwnProperty(a)){var b=this._opts.relationships[a];if(!b.isReverse){z.debug.isEnabled&&z.debug(this.name+": configuring relationship "+a,b);b.type||(b.type=this.singleton?l.OneToOne:l.OneToMany);if(this.singleton&&b.type==l.ManyToMany)return"Singleton model cannot use ManyToMany relationship.";if(b.type==l.OneToMany||b.type==l.OneToOne||
b.type==l.ManyToMany){var c=b.model;delete b.model;var h;if(c instanceof d)h=c;else{z.debug.isEnabled&&z.debug("reverseModelName",c);if(!this.collection)throw new p("Model must have collection");var k=this.collection;if(!k)throw new p("Collection "+this.collectionName+" not registered");h=k[c]}if(!h&&(k=c.split("."),2==k.length)){h=k[0];c=k[1];k=n[h];if(!k)return'Collection with name "'+h+'" does not exist.';h=k[c]}z.debug.isEnabled&&z.debug("reverseModel",h);if(h)b.reverseModel=h,b.forwardModel=
this,b.forwardName=a,b.reverseName=b.reverse||"reverse_"+a,delete b.reverse,b.isReverse=!1;else return'Model with name "'+c.toString()+'" does not exist'}else return"Relationship type "+b.type+" does not exist"}}this._relationshipsInstalled=!0;return null},installReverseRelationships:function(){if(this._reverseRelationshipsInstalled)throw new p('Reverse relationships for "'+this.name+'" have already been installed.');for(var b in this.relationships)if(this.relationships.hasOwnProperty(b)){var c=this.relationships[b],
c=a(!0,{},c);c.isReverse=!0;var h=c.reverseModel,k=c.reverseName;if(h.singleton){if(c.type==l.ManyToMany)return"Singleton model cannot be related via reverse ManyToMany";if(c.type==l.OneToMany)return"Singleton model cannot be related via reverse OneToMany"}z.debug.isEnabled&&z.debug(this.name+": configuring  reverse relationship "+k);h.relationships[k]=c}this._reverseRelationshipsInstalled=!0},_query:function(a){return a=new r(this,a||{})},query:function(a,b){if(this.singleton){var c=g.defer(b);b=
c.finish.bind(c);this._query({__ignoreInstalled:!0}).execute(function(c,h){c?b(c):(a=w.extend({},a),a.__ignoreInstalled=!0,h.length?this._query(a).execute(b):this.graph({},function(c){c?b(c):this._query(a).execute(b)}.bind(this)))}.bind(this));return c.promise}return this._query(a).execute(b)},reactiveQuery:function(a){return new A(new r(this,a||{}))},arrangedReactiveQuery:function(a){return new x(new r(this,a||{}))},one:function(a,b){"function"==typeof a&&(b=a,a={});var c=g.defer(b);b=c.finish.bind(c);
this.query(a,function(a,c){a?b(a):1<c.length?b("More than one instance returned when executing get query!"):(c=c.length?c[0]:null,b(null,c))});return c.promise},all:function(a,b){"function"==typeof a&&(b=a,a={});a=a||{};return this.query(a,b)},install:function(a){z.info.isEnabled&&z.info("Installing mapping "+this.name);var b=g.defer(a);a=b.finish.bind(b);if(this._installed)throw new p('Model "'+this.name+'" has already been installed');this._installed=!0;a();return b.promise},graph:function(a,b,
c){"function"==typeof b&&(c=b);b=b||{};var h=g.defer(c);c=function(){var c=b.override;c&&(g.isArray(c)?b.objects=c:b.objects=[c]);delete b.override;g.isArray(a)?this._mapBulk(a,b,h.finish.bind(h)):this._mapBulk([a],b,function(a,b){var c;b&&b.length&&(c=b[0]);h.finish(a?g.isArray(a)?a[0]:a:null,c)})}.bind(this);b._ignoreInstalled?c():siesta._afterInstall(c);return h.promise},_mapBulk:function(a,b,c){w.extend(b,{model:this,data:a});(new f(b)).start(function(a,b){a?c&&c(a):c(null,b||[])})},_countCache:function(){return w.reduce(Object.keys((c._localCacheByType[this.collectionName]||
{})[this.name]||{}),function(a,b){a[b]={};return a},{})},count:function(a){var b=g.defer(a);a=b.finish.bind(b);var c=this._countCache();a(null,Object.keys(c).length);return b.promise},_new:function(a,k){k=void 0===k?!0:k;if(this.installed){var d=this,e;e=a?a._id?a._id:B():B();var f=new m(this);z.info.isEnabled&&z.info('New object created _id="'+e.toString()+'", type='+this.name,a);f._id=e;e={};f.__values=e;var r=w.reduce(this.attributes,function(a,b){void 0!==b["default"]&&(a[b.name]=b["default"]);
return a},{});w.extend(e,r);a&&w.extend(e,a);e=this._attributeNames;r=e.indexOf(this.id);-1<r&&e.splice(r,1);w.each(e,function(a){Object.defineProperty(f,a,{get:function(){var b=f.__values[a];return void 0===b?null:b},set:function(c){var k=f.__values[a],e=this._propertyDependencies[a],e=w.map(e,function(a){return{prop:a,old:this[a]}}.bind(this));f.__values[a]=c;e.forEach(function(a){var c=a.prop;b.emit({collection:d.collectionName,model:d.name,_id:f._id,"new":this[c],old:a.old,type:D.Set,field:c,
obj:f})}.bind(this));k={collection:d.collectionName,model:d.name,_id:f._id,"new":c,old:k,type:D.Set,field:a,obj:f};window.lastEmission=k;b.emit(k);g.isArray(c)&&h(c,a,f)},enumerable:!0,configurable:!0})});w.each(Object.keys(this.methods),function(a){void 0===f[a]?f[a]=this.methods[a].bind(f):z.error('A method with name "'+a+'" already exists. Ignoring it.')}.bind(this));e=Object.keys(this.properties);var n={};w.each(e,function(a){var b=this.properties[a];(b.dependencies||[]).forEach(function(b){n[b]||
(n[b]=[]);n[b].push(a)});delete b.dependencies;void 0===f[a]?Object.defineProperty(f,a,b):z.error('A property/method with name "'+a+'" already exists. Ignoring it.')}.bind(this));f._propertyDependencies=n;Object.defineProperty(f,this.id,{get:function(){return f.__values[d.id]||null},set:function(a){var h=f[d.id];f.__values[d.id]=a;b.emit({collection:d.collectionName,model:d.name,_id:f._id,"new":a,old:h,type:D.Set,field:d.id,obj:f});c.remoteInsert(f,a,h)},enumerable:!0,configurable:!0});for(var x in this.relationships){var q;
if(this.relationships.hasOwnProperty(x))if(q=w.extend({},this.relationships[x]),e=q.type,delete q.type,e==l.OneToMany)q=new v(q);else if(e==l.OneToOne)q=new y(q);else if(e==l.ManyToMany)q=new C(q);else throw new p("No such relationship type: "+e);q.install(f)}c.insert(f);k&&b.emit({collection:this.collectionName,model:this.name,_id:f._id,"new":f,type:D.New,obj:f});return f}throw new p("Model must be fully installed before creating any models");},_dump:function(a){var b={};b.name=this.name;b.attributes=
this.attributes;b.id=this.id;b.collection=this.collectionName;b.relationships=w.map(this.relationships,function(a){return a.isForward?a.forwardName:a.reverseName});return a?g.prettyPrint(b):b},toString:function(){return"Model["+this.name+"]"}});w.extend(d.prototype,{child:function(a,b){"string"==typeof a?b.name=a:b=name;w.extend(b,{attributes:Array.prototype.concat.call(b.attributes||[],this._opts.attributes),relationships:w.extend(b.relationships||{},this._opts.relationships),methods:w.extend(w.extend({},
this._opts.methods)||{},b.methods),statics:w.extend(w.extend({},this._opts.statics)||{},b.statics),properties:w.extend(w.extend({},this._opts.properties)||{},b.properties),id:b.id||this._opts.id,init:b.init||this._opts.init,remove:b.remove||this._opts.remove});var c=this.collection.model(b.name,b);c.parent=this;this.children.push(c);return c},isChildOf:function(a){return this.parent==a},isParentOf:function(a){return-1<this.children.indexOf(a)},isDescendantOf:function(a){for(var b=this.parent;b;){if(b==
a)return!0;b=b.parent}return!1},isAncestorOf:function(a){return-1<this.descendants.indexOf(a)},hasAttributeNamed:function(a){return-1<this._attributeNames.indexOf(a)}});w.extend(d.prototype,{paginator:function(a){if(siesta.ext.httpEnabled){var b=siesta.ext.http.Paginator;a=a||{};a.model=this;return new b(a)}}});t.exports=d},{"./ArrangedReactiveQuery":1,"./OneToManyProxy":3,"./OneToOneProxy":4,"./RelationshipProxy":6,"./RelationshipType":7,"./cache":8,"./collectionRegistry":10,"./error":11,"./events":12,
"./log":14,"./manyToManyProxy":15,"./mappingOperation":16,"./modelEvents":18,"./modelInstance":19,"./query":22,"./reactiveQuery":24,"./store":26,"./util":28,extend:42}],18:[function(e,t,q){function d(d){this._opts=d||{};Object.keys(d).forEach(function(c){this[c]=d[c]}.bind(this))}function n(d){if(!d.model)throw new l("Must pass a model");if(!d.collection)throw new l("Must pass a collection");if(!d._id)throw new l("Must pass a local identifier");if(!d.obj)throw new l("Must pass the object");}var p=
e("./events"),l=e("./error").InternalSiestaError;t=e("./log");var r=e("./util")._.extend,f=e("./collectionRegistry").CollectionRegistry,m=t.loggerWithName("ModelEvents");d.prototype._dump=function(d){var c={};c.collection="string"==typeof this.collection?this.collection:this.collection._dump();c.model="string"==typeof this.model?this.model:this.model.name;c._id=this._id;c.field=this.field;c.type=this.type;this.index&&(c.index=this.index);this.added&&(c.added=_.map(this.added,function(a){return a._dump()}));
this.removed&&(c.removed=_.map(this.removed,function(a){return a._dump()}));this.old&&(c.old=this.old);this["new"]&&(c["new"]=this["new"]);return d?util.prettyPrint(c):c};r(q,{ModelEvent:d,emit:function(e){n(e);var c=e.collection,a=e.model;e=new d(e);m.trace.isEnabled&&m.trace('Sending notification "'+c+'" of type '+e.type);p.emit(c,e);var b=c+":"+a;m.trace.isEnabled&&m.trace('Sending notification "'+b+'" of type '+e.type);p.emit(b,e);m.trace.isEnabled&&m.trace('Sending notification "Siesta" of type '+
e.type);p.emit("Siesta",e);b=e._id;m.trace.isEnabled&&m.trace('Sending notification "'+b+'" of type '+e.type);p.emit(b,e);b=f[c];if(!b)throw c='No such collection "'+c+'"',m.error(c,f),new l(c);b=b[a];if(!b)throw c='No such model "'+a+'"',m.error(c,f),new l(c);b.id&&e.obj[b.id]&&(c=c+":"+a+":"+e.obj[b.id],m.trace.isEnabled&&m.trace('Sending notification "'+c+'" of type '+e.type),p.emit(c,e));return e},validateEventOpts:n,ModelEventType:{Set:"Set",Splice:"Splice",New:"New",Remove:"Remove"}})},{"./collectionRegistry":10,
...
b||Object.defineProperty(b,h,{get:function(){return f(k.pluck(b,h))},set:function(b){if(c.isArray(b)){if(this.length!=b.length)throw new a({message:"Must be same length"});for(var k=0;k<b.length;k++)this[k][h]=b[k]}else for(k=0;k<this.length;k++)this[k][h]=b}})}function p(a){return a.then&&a["catch"]}function l(a,b){b in a||(a[b]=function(){var a=arguments,c=this.map(function(c){return c[b].apply(c,a)}),h=!1;c.length&&(h=p(c[0]));return h?siesta.q.all(c):f(c)})}function r(a,c){a=k.extend([],a);c._attributeNames.concat(c._relationshipNames).concat(h).forEach(k.partial(n,
a));var h=Object.keys(b.prototype);h.forEach(k.partial(l,a));return g(a)}function f(a){if(a.length){var b=a[0];d(b).forEach(function(c){"function"==typeof b[c]?l(a,c,arguments):n(a,c)})}return g(a)}function m(){throw Error("Cannot modify a query set");}function g(a){h.forEach(function(b){a[b]=m});a.immutable=!0;a.mutableCopy=a.asArray=function(){var a=k.map(this,function(a){return a});a.asQuerySet=function(){return f(this)};a.asModelQuerySet=function(a){return r(this,a)};return a};return a}var c=
e("./util"),a=e("./error").SiestaUserError,b=e("./ModelInstance"),k=e("./util")._,h="push sort reverse splice shift unshift".split(" "),v=["toString","toExponential","toFixed","toPrecision","valueOf"],y=["MAX_VALUE","MIN_VALUE","NEGATIVE_INFINITY","NaN","POSITIVE_INFINITY"],C="charAt charCodeAt concat fromCharCode indexOf lastIndexOf localeCompare match replace search slice split substr substring toLocaleLowerCase toLocaleUpperCase toLowerCase toString toUpperCase trim valueOf".split(" "),A=["length"];
t.exports=r},{"./ModelInstance":2,"./error":11,"./util":28}],24:[function(e,t,q){function d(a){var b=this;n.call(this);g.extend(this,{_query:a,results:f([],a.model),insertionPolicy:d.InsertionPolicy.Back,initialised:!1});Object.defineProperties(this,{initialized:{get:function(){return this.initialised}},model:{get:function(){return b._query.model}},collection:{get:function(){return b.model.collectionName}}})}q=e("./log");e("./query");var n=e("events").EventEmitter,p=e("./events"),l=e("./modelEvents"),
r=e("./error").InternalSiestaError,f=e("./querySet"),m=e("./util"),g=m._,c=q.loggerWithName("Query");d.prototype=Object.create(n.prototype);g.extend(d,{InsertionPolicy:{Front:"Front",Back:"Back"}});g.extend(d.prototype,{init:function(a){c.trace&&c.trace("init");var b=m.defer(a);a=b.finish.bind(b);this.initialised?a(null,this.results):this._query.execute(function(b,h){if(b)a(b);else{this.results=h;if(!this.handler){var d=this._constructNotificationName(),e=function(a){this._handleNotif(a)}.bind(this);
this.handler=e;p.on(d,e)}c.trace&&c.trace("Listening to "+d);this.initialised=!0;a(null,this.results)}}.bind(this));return b.promise},insert:function(a){var b=this.results.mutableCopy();a=this.insertionPolicy==d.InsertionPolicy.Back?b.push(a):b.unshift(a);this.results=b.asModelQuerySet(this.model);return a},_handleNotif:function(a){c.trace&&c.trace("_handleNotif",a);if(a.type==l.ModelEventType.New){var b=a["new"];if(this._query.objectMatchesQuery(b)){c.trace&&c.trace("New object matches",b._dumpString());
var k=this.insert(b);this.emit("change",this.results,{index:k,added:[b],type:l.ModelEventType.Splice,obj:this})}else c.trace&&c.trace("New object does not match",b._dumpString())}else if(a.type==l.ModelEventType.Set){var b=a.obj,k=this.results.indexOf(b),h=-1<k,d=this._query.objectMatchesQuery(b);d&&!h?(c.trace&&c.trace("Updated object now matches!",b._dumpString()),k=this.insert(b),this.emit("change",this.results,{index:k,added:[b],type:l.ModelEventType.Splice,obj:this})):!d&&h?(c.trace&&c.trace("Updated object no longer matches!",
b._dumpString()),h=this.results.mutableCopy(),a=h.splice(k,1),this.results=h.asModelQuerySet(this.model),this.emit("change",this.results,{index:k,obj:this,"new":b,type:l.ModelEventType.Splice,removed:a})):d||h?d&&h&&(c.trace&&c.trace("Matches but already contains",b._dumpString()),this.emit("change",this.results,a)):c.trace&&c.trace("Does not contain, but doesnt match so not inserting",b._dumpString())}else if(a.type==l.ModelEventType.Remove)b=a.obj,h=this.results.mutableCopy(),k=h.indexOf(b),-1<
k?(c.trace&&c.trace("Removing object",b._dumpString()),a=h.splice(k,1),this.results=f(h,this.model),this.emit("change",this.results,{index:k,obj:this,type:l.ModelEventType.Splice,removed:a})):c.trace&&c.trace("No modelEvents neccessary.",b._dumpString());else throw new r('Unknown change type "'+a.type.toString()+'"');this.results=f(this._query._sortResults(this.results),this.model)},_constructNotificationName:function(){return this.model.collectionName+":"+this.model.name},terminate:function(){this.handler&&
p.removeListener(this._constructNotificationName(),this.handler);this.handler=this.results=null},listen:function(a){this.on("change",a);return function(){this.removeListener("change",a)}.bind(this)},listenOnce:function(a){this.once("change",a)}});t.exports=d},{"./error":11,"./events":12,"./log":14,"./modelEvents":18,"./query":22,"./querySet":23,"./util":28,events:38}],25:[function(e,t,q){t.exports=e(6)},{"../vendor/observe-js/src/observe":44,"./cache":8,"./error":11,"./events":12,"./log":14,"./modelEvents":18,
"./query":22,"./store":26,"./util":28,"/Users/mtford/Playground/rest/core/RelationshipProxy.js":6}],26:[function(e,t,q){function d(d,c){var a=l.defer(c);c=a.finish.bind(a);m.debug.isEnabled&&m.debug("get",d);var b;if(d._id)if(l.isArray(d._id))n(r.map(d._id,function(a){return{_id:a}}),c);else if(b=f.get(d))m.debug.isEnabled&&m.debug("Had cached object",{opts:d,obj:b}),c&&c(null,b);else if(l.isArray(d._id))n(r.map(d._id,function(a){return{_id:a}}),c);else{if(c)if(b=siesta.ext.storage)b.store.getFromPouch(d,
c);else throw Error("Storage module not installed");}else if(d.model)if(l.isArray(d[d.model.id]))n(r.map(d[d.model.id],function(a){var b={};b[d.model.id]=a;b.model=d.model;return b}),c);else if(b=f.get(d))m.debug.isEnabled&&m.debug("Had cached object",{opts:d,obj:b}),c&&c(null,b);else if(b=d.model,b.singleton)b.one(c);else{var k=b.id,h=d[k],e={};if(e[k]=h)b.one(e,function(a,b){a?c(a):b?c(null,b):c(null,null)});else throw new p('Invalid options given to store. Missing "'+k.toString()+'."');}else throw new p("Invalid options given to store",
{opts:d});return a.promise}function n(e,c){var a=l.defer(c);c=a.finish.bind(a);var b=[],k=[];r.each(e,function(a){d(a,function(a,h){a?k.push(a):b.push(h);b.length+k.length==e.length&&c&&(k.length?c(k):c(null,b))})});return a.promise}var p=e("./error").InternalSiestaError;q=e("./log");var l=e("./util"),r=l._,f=e("./cache"),m=q.loggerWithName("Store");t.exports={get:d,getMultiple:n,getMultipleLocal:function(d,c){var a=l.defer(c);c=a.finish.bind(a);var b=r.reduce(d,function(a,b){var c=f.get({_id:b});
c?a.cached[b]=c:a.notCached.push(b);return a},{cached:{},notCached:[]});(function(a){c&&(a?c(a):c(null,r.map(d,function(a){return b.cached[a]})))})();return a.promise},getMultipleRemote:function(d,c,a){var b=l.defer(a);a=b.finish.bind(b);var k=r.reduce(d,function(a,b){var d={model:c};d[c.id]=b;(d=f.get(d))?a.cached[b]=d:a.notCached.push(b);return a},{cached:{},notCached:[]});(function(b){a&&(b?a(b):a(null,r.map(d,function(a){return k.cached[a]})))})();return b.promise}}},{"./cache":8,"./error":11,
"./log":14,"./util":28}],27:[function(e,t,q){function d(a,b){if(a.map)return a.map(b);var c=[];r(a,function(a,d,h){c.push(b(a,d,h))});return c}function n(a,b,c,k){b=d(b,function(a,b){return{index:b,value:a}});if(k){var e=[];a(b,function(a,b){c(a.value,function(c,d){e[a.index]=d;b(c)})},function(a){k(a,e)})}else a(b,function(a,b){c(a.value,function(a){b(a)})})}function p(a,b,c){c=c||function(){};if(!a.length)return c();var d=0,k=function(){b(a[d],function(b){b?(c(b),c=function(){}):(d+=1,d>=a.length?
c():k())})};k()}function l(a,b){if(a.forEach)return a.forEach(b);for(var c=0;c<a.length;c+=1)b(a[c],c,a)}function r(a,b,c){function d(b){b?(c(b),c=function(){}):(k+=1,k>=a.length&&c())}c=c||function(){};if(!a.length)return c();var k=0;l(a,function(a){b(a,f(d))})}function f(b){var c=!1;return function(){if(c)throw Error("Callback was already called.");c=!0;b.apply(a,arguments)}}var m=e("./misc"),g=e("./underscore"),c=function(a){return function(){var b=Array.prototype.slice.call(arguments);return a.apply(null,
[r].concat(b))}}(n),a,b=function(a){return function(){var b=Array.prototype.slice.call(arguments);return a.apply(null,[p].concat(b))}}(n),k=function(a,b,c){c=c||function(){};if(m.isArray(b))a.map(b,function(a,b){a&&a(function(a){var c=Array.prototype.slice.call(arguments,1);1>=c.length&&(c=c[0]);b.call(null,a,c)})},c);else{var d={};a.each(Object.keys(b),function(a,c){b[a](function(b){var k=Array.prototype.slice.call(arguments,1);1>=k.length&&(k=k[0]);d[a]=k;c(b)})},function(a){c(a,d)})}};t.exports=
{series:function(a,c){c=c||function(){};if(m.isArray(a))b(a,function(a,b){a&&a(function(a){var c=Array.prototype.slice.call(arguments,1);1>=c.length&&(c=c[0]);b.call(null,a,c)})},c);else{var d={};p(g.keys(a),function(b,c){a[b](function(a){var k=Array.prototype.slice.call(arguments,1);1>=k.length&&(k=k[0]);d[b]=k;c(a)})},function(a){c(a,d)})}},parallel:function(a,b){k({map:c,each:r},a,b)}}},{"./misc":29,"./underscore":30}],28:[function(e,t,q){q=e("./underscore");var d=e("./async");e=e("./misc");q.extend(t.exports,
{_:q,async:d});q.extend(t.exports,e)},{"./async":27,"./misc":29,"./underscore":30}],29:[function(e,t,q){var d=e("../../vendor/observe-js/src/observe").Platform,n=e("./underscore"),p=e("./../error").InternalSiestaError,l=/^function\s*[^\(]*\(\s*([^\)]*)\)/m,r=/,/,f=/^\s*(_?)(.+?)\1\s*$/,m=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg;e=function(a){return"[object Array]"===n.toString.call(a)};var g=Array.isArray||e,c=function(a){return"string"==typeof a||a instanceof String};n.extend(t.exports,{next:function(a){d.performMicrotaskCheckpoint();
setTimeout(a)},cb:function(a,b){return function(c){a&&a.apply(a,arguments);b&&(c?b.reject(c):b.resolve.apply(b,Array.prototype.slice.call(arguments,1)))}},guid:function(){function a(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return function(){return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()}}(),assert:function(a,b,c){if(!a)throw c=c||{},new p(b||"Assertion failed",c);},thenBy:function(){function a(a){a.thenBy=b;return a}function b(b){var c=this;return a(function(a,
d){return c(a,d)||b(a,d)})}return a}(),defer:function(a){var b;a=a||function(){};if(siesta.q){b=siesta.q.defer();var c=b.reject,d=b.resolve;n.extend(b,{reject:function(b){a(b);c.call(this,b)},resolve:function(b){var c=a.__siesta_bound_object||a,k=Array.prototype.slice.call(arguments,0);k.unshift(null);a.apply(c,k);d.apply(this,arguments)},finish:function(a,b){if(a)this.reject(a);else{var c=Array.prototype.slice.call(arguments,1);this.resolve.apply(this,c)}}})}else b={promise:void 0,reject:function(b){a.apply(a.__siesta_bound_object||
a,arguments)},resolve:function(b){var c=a.__siesta_bound_object||a,d=Array.prototype.slice.call(arguments,0);d.unshift(null);a.apply(c,d)},finish:function(b,c){a.apply(a.__siesta_bound_object||a,arguments)}};return b},defineSubProperty:function(a,b,c){return Object.defineProperty(this,a,{get:function(){return c?b[c]:b[a]},set:function(d){c?b[c]=d:b[a]=d},enumerable:!0,configurable:!0})},defineSubPropertyNoSet:function(a,b,c){return Object.defineProperty(this,a,{get:function(){return c?b[c]:b[a]},
enumerable:!0,configurable:!0})},subProperties:function(a,b,d){g(d)||(d=Array.prototype.slice.call(arguments,2));for(var h=0;h<d.length;h++)(function(d){var k={set:!1,name:d,property:d};c(d)||n.extend(k,d);d={get:function(){return b[k.property]},enumerable:!0,configurable:!0};k.set&&(d.set=function(a){b[k.property]=a});Object.defineProperty(a,k.name,d)})(d[h])},capitaliseFirstLetter:function(a){return a.charAt(0).toUpperCase()+a.slice(1)},extendFromOpts:function(a,b,c,d){if(void 0==d||d){var e=Object.keys(c);
d=Object.keys(b).filter(function(a){return-1==e.indexOf(a)});if(d.length)throw Error("Unknown options: "+d.toString());}n.each(Object.keys(c),function(a){var d=c[a];"function"==typeof d&&(c[a]=d(b[a]),delete b[a])});n.extend(c,b);n.extend(a,c)},isString:c,isArray:g,prettyPrint:function(a){return JSON.stringify(a,null,4)},flattenArray:function(a){return n.reduce(a,function(a,c){g(c)?a=a.concat(c):a.push(c);return a},[])},unflattenArray:function(a,b){for(var c=0,d=[],e=0;e<b.length;e++)if(g(b[e])){var f=
[];d[e]=f;for(var l=0;l<b[e].length;l++)f.push(a[c]),c++}else d[e]=a[c],c++;return d},paramNames:function(a){var b=[];a.toString().replace(m,"").match(l)[1].split(r).forEach(function(a){a.replace(f,function(a,c,d){b.push(d)})});return b}})},{"../../vendor/observe-js/src/observe":44,"./../error":11,"./underscore":30}],30:[function(e,t,q){var d={};e=Array.prototype;var n=e.forEach,p=e.map,l=e.reduce,r=Function.prototype.bind,f=e.slice,m={},g=function(){};d.keys=function(a){if(Object.keys)return Object.keys(a);
var c=[],d;for(d in a)a.hasOwnProperty(d)&&c.push(d);return c};d.each=d.forEach=function(a,c,h){if(null==a)return a;if(n&&a.forEach===n)a.forEach(c,h);else if(a.length===+a.length)for(var e=0,f=a.length;e<f;e++){if(c.call(h,a[e],e,a)===m)return}else for(var g=d.keys(a),e=0,f=g.length;e<f;e++)if(c.call(h,a[g[e]],g[e],a)===m)return;return a};d.map=d.collect=function(a,c,e){var f=[];if(null==a)return f;if(p&&a.map===p)return a.map(c,e);d.each(a,function(a,b,d){f.push(c.call(e,a,b,d))});return f};var c=
...
m=e.CollectionRegistry,g=e.extend,c=l._,a=e.log.loggerWithName("Descriptor"),b="POST PATCH PUT HEAD GET DELETE OPTIONS TRACE CONNECT".split(" ");c.extend(n.prototype,{httpMethods:b,_resolveCollectionAndModel:function(){var a;a=this._opts.collection;var b=this._opts.model;console.log("rawCollection",a);console.log("rawModel",b);if(a)a="string"==typeof a?m[a]:a;else if(b&&!l.isString(b))a=b.collection;else return"Must pass collection or a model object";var c;if(b)if(l.isString(b))if(c=a._models[b])this._opts.model=
...
_serialiseObject:l,Paginator:e("./paginator")};Object.defineProperty(e,"ajax",{get:function(){return E||($?$.ajax:null)||(jQuery?jQuery.ajax:null)},set:function(a){E=a}});x.extend(q.prototype,{DELETE:f,GET:g,TRACE:a,OPTIONS:c,HEAD:b,POST:k,PUT:h,PATCH:v});siesta.ext||(siesta.ext={});siesta.ext.http=e;Object.defineProperties(siesta.ext,{httpEnabled:{get:function(){return void 0!==siesta.ext._httpEnabled?siesta.ext._httpEnabled:!!siesta.ext.http},set:function(a){siesta.ext._httpEnabled=a},enumerable:!0}});
...
e,g){if(d)if("function"==typeof d)e=d(e,g);else for(d=d.split("."),g=0;g<d.length;g++)e=e[d[g]];return e},_extractData:function(d,e){return this._extract(this.opts.dataPath,d,e)},_extractNumPages:function(d,e){return this._extract(this.opts.numPages,d,e)},_extractCount:function(d,e){return this._extract(this.opts.count,d,e)},_parseURL:function(d){var e=document.createElement("a");e.href=d;return e},page:function(d,e){var g=this,c={};"function"==typeof d?e=d:d&&(c=d);var a=p.defer(e),b=c.page,c=c.pageSize;
e=a.finish.bind(a);var k=siesta.ext.http.ajax,h=l.extend({},this.opts),n=this.opts.model.collection.baseURL+this.opts.path;if(this.opts.queryParams){var n=this._parseURL(n),q=n.search,t=q.split("?");1<t.length&&(q=t[1]);q=r.parse(q);b&&(q[this.opts.page]=b);c&&(q[this.opts.pageSize]=c);Object.keys(q).length&&(n.search="?"+r.stringify(q));n=n.href}else q={},b&&(q[this.opts.page]=b),c&&(q[this.opts.pageSize]=c),h.data=q;l.extend(h,{url:n,success:function(a,b,c){var d=g._extractData(a,c),f=g._extractCount(a,
...
"serialiser",this._opts);r.call(this,"serializer",this._opts,"serialiser")}var n=e("./descriptor").Descriptor,p=e("./serialiser");e=siesta._internal;var l=e.util;t=l._;var r=l.defineSubProperty,f=e.log.loggerWithName("Descriptor");d.prototype=Object.create(n.prototype);t.extend(d.prototype,{_serialise:function(d,e){var c=l.defer(e);e=c.finish.bind(c);var a=this;f.trace.isEnabled&&f.trace("_serialise");var b,k=this.serialiser(d,function(c,d){b||(d=a._transformData(d),e&&e(c,a._embedData(d)))});void 0!==
k?(f.trace.isEnabled&&f.trace("serialiser doesnt use a callback"),b=!0,k=a._transformData(k),e&&e(null,a._embedData(k))):f.trace.isEnabled&&f.trace("serialiser uses a callback",this.serialiser);return c.promise},_dump:function(d){var e={};e.methods=this.method;e.model=this.model.name;e.path=this._rawOpts.path;e.serialiser="function"==typeof this._rawOpts.serialiser?"function () { ... }":this._rawOpts.serialiser;var c={},a;for(a in this.transforms)this.transforms.hasOwnProperty(a)&&(c[a]="function"==
typeof this.transforms[a]?"function () { ... }":this.transforms[a]);e.transforms=c;return d?l.prettyPrint(e):e}});q.RequestDescriptor=d},{"./descriptor":31,"./serialiser":37}],36:[function(e,t,q){function d(e){if(!this)return new d(e);n.call(this,e)}var n=e("./descriptor").Descriptor;e=siesta._internal.util._;d.prototype=Object.create(n.prototype);e.extend(d.prototype,{_extractData:function(d){(d=n.prototype._extractData.call(this,d))&&(d=this._transformData(d));return d},_matchData:function(d){(d=
...
p.debug.isEnabled&&p.debug("No idfield")}function n(d,e,m){m=m||function(){};p.trace.isEnabled&&p.trace("depthSerialiser");var g={};l.each(e._attributeNames,function(a){p.trace.isEnabled&&p.trace("field",a);e[a]&&(g[a]=e[a])});var c=[],a=[],b={},k=[];l.each(e._relationshipNames,function(h){p.trace.isEnabled&&p.trace("relationshipField",h);var l=e.__proxies[h];l.isForward&&(p.debug.isEnabled&&p.debug(h),c.push(h),l.get(function(l,q){p.trace.isEnabled&&p.trace("proxy.get",h);p.debug.isEnabled&&p.debug(h,
q);l?(a.push(l),k.push(h),b[h]={err:l,v:q}):q?d?n(d-1,q,function(d,e,f){d?a.push(d):g[h]=e;k.push(h);b[h]={err:d,v:q,resp:f};c.length==k.length&&m&&m(a.length?a:null,g,b)}):(k.push(h),g[h]=q[e.__proxies[h].forwardModel.id],b[h]={err:l,v:q},c.length==k.length&&m&&m(a.length?a:null,g,b)):(p.debug.isEnabled&&p.debug("no value for "+h),k.push(h),b[h]={err:l,v:q},c.length==k.length&&m&&m(a.length?a:null,g,b))}))});c.length||m(null,g,{})}e=siesta._internal;t=e.util;var p=e.log.loggerWithName("Serialisation"),
...
42:[function(e,t,q){var d=Object.prototype.hasOwnProperty,n=Object.prototype.toString,p=function(e){if(!e||"[object Object]"!==n.call(e)||e.nodeType||e.setInterval)return!1;var p=d.call(e,"constructor"),f=e.constructor&&e.constructor.prototype&&d.call(e.constructor.prototype,"isPrototypeOf");if(e.constructor&&!p&&!f)return!1;for(var m in e);return void 0===m||d.call(e,m)};t.exports=function r(){var d,e,g,c,a,b=arguments[0],k=1,h=arguments.length,n=!1;if("boolean"===typeof b)n=b,b=arguments[1]||{},
k=2;else if("object"!==typeof b&&"function"!==typeof b||void 0==b)b={};for(;k<h;++k)if(null!=(d=arguments[k]))for(e in d)g=b[e],c=d[e],b!==c&&(n&&c&&(p(c)||(a=Array.isArray(c)))?(a?(a=!1,g=g&&Array.isArray(g)?g:[]):g=g&&p(g)?g:{},b[e]=r(n,g,c)):void 0!==c&&(b[e]=c));return b}},{}],43:[function(e,t,q){if("undefined"==typeof siesta&&"undefined"==typeof t)throw Error("Could not find window.siesta. Make sure you include siesta.core.js first.");var d=siesta._internal,n=d.CollectionRegistry,p=d.util,l=
p._,r=d.events,f=[],m={},g={};e={};var c=d.log.loggerWithName("Storage");if("undefined"==typeof PouchDB)siesta.ext.storageEnabled=!1,console.log("PouchDB is not present therefore storage is disabled.");else{q=function(b){var d=p.defer(b);siesta._afterInstall(function(){b=b||function(){};var e=f;f=[];m={};g={};c.trace&&c.trace("Saving objects",l.map(e,function(a){return a._dump()}));a(e,b,d)});return d.promise};var a=function(a,d,e){var f=[];y.bulkDocs(l.map(a,v)).then(function(g){for(var h=0;h<g.length;h++){var k=
g[h],l=a[h];k.ok?l._rev=k.rev:409==k.status?f.push(l):c.error('Error saving object with _id="'+l._id+'"',k)}f.length?b(f,d,e):(d(),e&&e.resolve())},function(a){d(a);e&&e.reject(a)})},b=function(b,c,d){y.allDocs({keys:l.pluck(b,"_id")}).then(function(e){for(var f=0;f<e.rows.length;f++)b[f]._rev=e.rows[f].value.rev;a(b,c,d)})["catch"](function(a){d.reject(a)})},k=function(a,b){var d=a.collectionName,e=a.modelName;if(c.trace){var f=d+"."+e;c.trace("Loading instances for "+f)}var g=n[d][e],d=function(a){"$1"==
a.model&&"$2"==a.collection&&emit(a._id,a)}.toString().replace("$1",e).replace("$2",d);c.trace.isEnabled&&c.trace("Querying pouch");y.query({map:d}).then(function(a){c.trace.isEnabled&&c.trace("Queried pouch succesffully");a=siesta._.map(siesta._.pluck(a.rows,"value"),function(a){return h(a,g)});c.trace.isEnabled&&c.trace("Mapping data",a);g.graph(a,{disableevents:!0,_ignoreInstalled:!0,callInit:!1},function(a,d){a?c.error("Error loading models",a):c.trace.isEnabled&&c.trace("Loaded "+d?d.length.toString():
"0 instances for "+f);b(a,d)})})["catch"](function(a){b(a)})},h=function(a,b){delete a.collection;delete a.model;l.each(b._relationshipNames,function(b){var c=a[b];siesta.isArray(c)?a[b]=l.map(c,function(a){return{_id:a}}):a[b]={_id:c}});return a},v=function(a){var b=siesta._.extend({},a.__values);b.collection=a.collectionName;b.model=a.modelName;b._id=a._id;a.removed&&(b._deleted=!0);var c=a._rev;c&&(b._rev=c);return b=l.reduce(a._relationshipNames,function(b,c){var d=a[c];siesta.isArray(d)?b[c]=
l.pluck(d,"_id"):d&&(b[c]=d._id);return b},b)},y=new PouchDB("siesta"),C=function(a){a=a.obj;var b=a._id;if(!a)throw new d.error.InternalSiestaError("No obj field in notification received by storage extension");if(!(b in m)){m[b]=a;f.push(a);var c=a.collectionName;g[c]||(g[c]={});var e=a.model.name;g[c][e]||(g[c][e]={});g[c][e][b]=a}};siesta.on("Siesta",C);l.extend(e,{_load:function(a){if(x)throw Error("not loaded yet how can i save");var b=p.defer(a);if(siesta.ext.storageEnabled){var d=[];l.each(n.collectionNames,
function(a){var b=Object.keys(n[a]._models);l.each(b,function(b){d.push(function(c){k({collectionName:a,modelName:b},c)})})});siesta.async.parallel(d,function(a,d){if(!a){var e=[];siesta._.each(d,function(a){e.concat(a)});c.trace&&c.trace("Loaded "+e.length.toString()+" instances")}b.finish(a)})}else b.finish();return b.promise},save:q,_serialise:v,_reset:function(a){siesta.removeListener("Siesta",C);f=[];m={};y.destroy(function(b){b||(y=new PouchDB("siesta"));siesta.on("Siesta",C);c.warn("Reset complete");
a(b)})}});Object.defineProperties(e,{_unsavedObjects:{get:function(){return f}},_unsavedObjectsHash:{get:function(){return m}},_unsavedObjectsByCollection:{get:function(){return g}},_pouch:{get:function(){return y}}});siesta.ext||(siesta.ext={});siesta.ext.storage=e;Object.defineProperties(siesta.ext,{storageEnabled:{get:function(){return void 0!==siesta.ext._storageEnabled?siesta.ext._storageEnabled:!!siesta.ext.storage},set:function(a){siesta.ext._storageEnabled=a},enumerable:!0}});var A,x,w=1E3;
...
b))});return c},z=[],E=w?function(){var a={pingPong:!0},b=!1;Object.observe(a,function(){m();b=!1});return function(c){z.push(c);b||(b=!0,a.pingPong=!a.pingPong)}}():function(){return function(a){z.push(a)}}(),K=[],L=0,F=1,M=1;c.prototype={open:function(a,b){if(this.state_!=L)throw Error("Observer has already been opened.");c._allObserversCount++;H&&G.push(this);this.callback_=a;this.target_=b;this.connect_();this.state_=F;return this.value_},close:function(){this.state_==F&&(c._allObserversCount--,
